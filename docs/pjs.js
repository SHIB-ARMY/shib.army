...
function ParticleSlider(a) {
    ...
    if (a) {
        ...
        for (var c = 0, d = this.length;
            c < d;
            c++)b = Math.floor(Math.random() * d), a = this[c], this[c] = this[b], this[b] = a
    }, Array.prototype.shuffle = b.shuffle, b.$canv.onmouseout = function () { b.mx = -1, b.my = -1, b.mouseDownRegion = 0 }, b.$canv.onmousemove = function (a) {
        function c(a) {
    ...
    if (b.imgs.length == 0) for (var d = 0, e = b.$$slides.length;
        d < e;
        d++) {
            var f = new Image;
...
} var psParticle = function (a) { this.ps = a, this.ttl = null, this.color = a.colorArr, this.next = null, this.prev = null, this.gravityX = 0, this.gravityY = 0, this.x = Math.random() * a.cw, this.y = Math.random() * a.ch, this.velocityX = Math.random() * 10 - 5, this.velocityY = Math.random() * 10 - 5 };
psParticle.prototype.move = function () {
    ...
    if (this.ttl != null && this.ttl-- <= 0) a.swapList(b, a.pxlBuffer, a.recycleBuffer), this.ttl = null;
        ...
        var c = this.gravityX + a.swipeOffset - this.x, d = this.gravityY - this.y, e = Math.sqrt(Math.pow(c, 2) + Math.pow(d, 2)), f = Math.atan2(d, c), g = e * .01;
    ...
    var a = this;
    a.imagesLoaded++;
    if (a.imagesLoaded >= 3 || a.showArrowControls == !1) a.resize(), a.slideDelay > 0 && (a.nextSlideTimer = setTimeout(function () { a.nextSlide() }, 1e3 * a.slideDelay))
    ...
    if (a[0] == ".") {
        ...
        for (var g = 0, h = b.length;
            g < h;
            g++)b[g].className && b[g].className == e && f.push(b[g]);
    ...
    while (j != null) {
        e = ~~j.x, f = ~~j.y;
        for (g = e;
            g < e + a.ptlSize && g >= 0 && g < a.cw;
            g++)for (h = f;
                h < f + a.ptlSize && h >= 0 && h < a.ch;
                h++)d = (h * b.width + g) * 4, i = typeof j.color == "function" ? j.color() : j.color, c[d + 0] = i[0], c[d + 1] = i[1], c[d + 2] = i[2], c[d + 3] = i[3];
        j = j.next
    ...
    for (var f = 0;
        f < a.width;
        f += d.ptlGap + 1)for (var g = 0;
            g < a.height;
            g += d.ptlGap + 1)i = (g * a.width + f) * 4, a.data[i + 3] > 0 && e.push({ x: b + f, y: c + g, color: d.monochrome == !0 ? [d.colorArr[0], d.colorArr[1], d.colorArr[2], d.colorArr[3]] : [a.data[i], a.data[i + 1], a.data[i + 2], a.data[i + 3]] });
    return e
    ...
    if (b.imgs.length > 0) {
        ...
        if (b.showArrowControls == !0) {
            ...
            for (var e = 0, f = d.length;
                e < f;
                e++)d[e].color = function () { return b.mx >= 0 && b.mx < b.arrowPadding * 2 + b.$prevCanv.width ? b.hoverColorArr : b.colorArr }, c.push(d[e]);
            ...
            for (var e = 0, f = g.length;
                e < f;
                e++)g[e].color = function () { return b.mx > 0 && b.mx > b.cw - (b.arrowPadding * 2 + b.$nextCanv.width) ? b.hoverColorArr : b.colorArr }, c.push(g[e])
    ...
    var b = this, c = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (a) { window.setTimeout(a, 1e3 / 60) };
    c(a)
}
    ;
